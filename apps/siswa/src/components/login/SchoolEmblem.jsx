export default function SchoolEmblem({ size = 48 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      ...
      <path d="M24 14 L30 18 V26 C30 28.5 27 30.5 24 31 C21 30.5 18 28.5 18 26 V18 Z" fill="#1a48a0" fillOpacity="0.3" />
      <path d="M22 20 H26 V28 H22 Z" fill="#1a48a0" />
      <path d="M20 18 H28 V20 H20 Z" fill="#1a48a0" />
