...
export const PAYMENT_STATUS = {
  PENDING: { label: 'Menunggu Verifikasi', cls: 'bg-amber-100 text-amber-800 dark:bg-amber-900/40 dark:text-amber-300' },
  VERIFIED: { label: 'Berhasil', cls: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-300' },
