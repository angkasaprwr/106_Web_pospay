export default function LoginIllustration() {
  return (
    <svg viewBox="0 0 420 280" className="mx-auto w-full max-w-md" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <ellipse cx="210" cy="250" rx="150" ry="18" fill="rgba(255,255,255,0.12)" />
      <rect x="95" y="70" width="230" height="150" rx="12" fill="#fff" fillOpacity="0.95" />
      <rect x="108" y="82" width="204" height="18" rx="4" fill="#E8F0FE" />
      <circle cx="118" cy="91" r="3" fill="#FF6B6B" />
      ...
      <circle cx="87" cy="146" r="3" fill="#fff" fillOpacity="0.8" />
      <rect x="340" y="175" width="28" height="36" rx="3" fill="#8B5E3C" />
      <rect x="336" y="171" width="36" height="6" rx="2" fill="#A67C52" />
      <rect x="368" y="175" width="28" height="36" rx="3" fill="#6B4423" />
      <rect x="364" y="171" width="36" height="6" rx="2" fill="#8B5E3C" />
      <path d="M375 215 C375 225 385 232 395 232 C405 232 415 225 415 215" stroke="#4ADE80" strokeWidth="2" fill="none" />
      <ellipse cx="395" cy="215" rx="14" ry="8" fill="#22C55E" />
      <rect x="389" y="205" width="12" height="14" rx="2" fill="#16A34A" />
    </svg>
  );
}
