...
export default function Register() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white lg:flex-row">
      ...
      <div className="flex w-full flex-1 items-center justify-center bg-white px-4 py-8 sm:px-8 lg:w-1/2 lg:px-12 lg:py-10">
          ...
          <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-[0_8px_40px_rgba(0,71,171,0.08)] sm:p-8">
            {!open ? (
              <div className="text-center">
                ...
                <h2 className="text-xl font-extrabold text-pospay">Registrasi Ditutup</h2>
              ...
              <>
                <div className="mb-6">
                  <h1 className="text-2xl font-extrabold text-pospay sm:text-[28px]">Daftar Akun</h1>
                  <p className="mt-1 text-sm text-slate-500">Buat akun bendahara untuk mengelola keuangan sekolah</p>
                </div>
