...
/* ════════════════════════════════════════════════════════
   LEFT PANEL  (shared — exported so Register.jsx can import)
════════════════════════════════════════════════════════ */
...
export default function Login() {
  ...
  return (
    /* Outer: left blue panel + right gray panel */
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-1 items-center justify-center bg-[#f0f4ff] dark:bg-slate-900 px-4 py-10 sm:px-8">
        ...
        {/* Floating white card — visible on ALL screen sizes */}
        <div className="w-full max-w-[420px] rounded-2xl border border-slate-200 bg-white
          ...
          {/* Register link — always rendered, shown when registration open */}
          <p className="text-center text-[15px] font-semibold text-slate-700 dark:text-slate-300">
            Belum memiliki akun?{' '}
            <button
              type="button"
