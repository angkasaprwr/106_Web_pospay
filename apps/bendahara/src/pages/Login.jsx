...
/* ════════════════════════════════════════════════════════════════
   SVG ILLUSTRATION
   Matches image: laptop dashboard · chat bubble · Rp card · books · plant
════════════════════════════════════════════════════════════════ */
function LoginIllustration() {
  return (
    <svg viewBox="0 0 520 330" fill="none" xmlns="http://www.w3.org/2000/svg"
      ...
      {/* ── LINE CHART (left half of screen) ── */}
      ...
      {/* ── Rp CARD (top-right, overlapping laptop) ── */}
...
/* ════════════════════════════════════════════════════════════════
   LEFT PANEL  (exported → Register.jsx can import)
════════════════════════════════════════════════════════════════ */
      ...
      <div className="relative flex h-full flex-col justify-between px-8 xl:px-10 py-10">
        ...
        <div className="border-t pt-5" style={{ borderColor: 'rgba(255,255,255,0.15)' }}>
          <p style={{
            ...
            textTransform: 'uppercase', color: 'rgba(191,219,254,0.80)',
            marginBottom: 10,
          }}>
            Studi Kasus
          </p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p style={{ fontWeight: 700, fontSize: 16, lineHeight: 1.2 }}>
          ...
          <p style={{
            marginTop: 10, fontSize: 11.5, lineHeight: 1.65,
...
export default function Login() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      {/* RIGHT PANEL — light-blue background + floating white card */}
      <div
        style={{
          flex: 1,
          display: 'flex',
        ...
        >
          ...
          <form onSubmit={submit}>
              ...
              <div style={{
                ...
                <button
                  ...
                  style={{
                    ...
                    width: 44, flexShrink: 0, background: 'none', border: 'none',
            ...
            <button
              ...
              onMouseOut={e => { if (!loading) e.currentTarget.style.backgroundColor = '#1d4ed8'; }}
            >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '20px 0' }}>
            ...
            <span style={{ fontSize: 13, color: '#9ca3af' }}>atau</span>
            <div style={{ flex: 1, height: 1, backgroundColor: '#e2e8f0' }}/>
          </div>

          {/* REGISTER LINK */}
          <p style={{ textAlign: 'center', fontSize: 15, fontWeight: 600, color: '#374151' }}>
            Belum memiliki akun?{' '}
            <button
              type="button"
              ...
              style={{
                ...
                textDecoration: canRegister ? 'none' : 'none',
              }}
            >
              daftar
            </button>
